<p align="center">
<a href="https://duckietown.com"><img src="https://raw.githubusercontent.com/duckietown/lx-dd-docker/ente/assets/images/dtlogo.png" alt="Duckietown Logo" width="50%"></a>
</p>

# Recipe: Docker LX

This is the recipe for the [`lx-dd-docker`](https://github.com/duckietown/lx-dd-docker)
...
`lx-dd-docker/.dtproject` points at it:

    RECIPE_REPOSITORY=duckietown/lx-dd-docker-recipe
    RECIPE_BRANCH=ente
